...
const mocks = vi.hoisted(() => ({ auth: vi.fn(), upsert: vi.fn(), count: vi.fn(), transaction: vi.fn(), monthly: vi.fn(), wins: vi.fn() }));
...
vi.mock("@/lib/scoreboard", () => ({ monthlyScoreboard: mocks.monthly, scoreboardWins: mocks.wins }));
