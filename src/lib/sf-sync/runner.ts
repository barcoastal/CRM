...
const ENTITIES = ["account", "contact", "opportunity", "programplan", "draft", "debt", "fee", "case", "offer", "settlement", "task", "event", "emailmessage", "paymentsummary", "accounthistory", "file", "lead"] as const;
