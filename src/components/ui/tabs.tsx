  ...
  return (
    <TabsPrimitive.Trigger
      ...
      className={cn(
        ...
        "data-[state=active]:bg-white data-[state=active]:shadow-coastal data-[state=active]:text-[#3052ff] dark:data-[state=active]:text-[#3052ff] dark:data-[state=active]:border-transparent dark:data-[state=active]:bg-white",
