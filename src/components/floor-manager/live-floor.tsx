  ...
  return (
    <div>
      <header style={{ background: "#fff", padding: "16px 24px", border: "1px solid #c9c9c9", borderRadius: 4, marginBottom: 16 }}>
        <h2 style={{ fontSize: 20, fontWeight: 700, color: "#181818", margin: 0 }}>Live Floor</h2>
      ...
      <div style={{ background: "#fff", border: "1px solid #c9c9c9", borderRadius: 4, overflow: "hidden", marginBottom: 20 }}>
        ...
        <table style={{ width: "100%", borderCollapse: "collapse" }}>
          ...
          <tbody>
            ...
            {scheduled.length === 0 && <tr><td colSpan={5} style={{ ...td, textAlign: "center", color: "#747474", padding: 20 }}>No scheduled calls. Bookings from your scheduling link appear here. <Link href="/floor-manager/meetings" style={{ color: "#0176d3", textDecoration: "none" }}>See all meetings</Link>.</td></tr>}
          </tbody>
        </table>
      </div>
      ...
      <div style={{ background: "#fff", border: "1px solid #c9c9c9", borderRadius: 4, overflow: "hidden" }}>
        ...
        <table style={{ width: "100%", borderCollapse: "collapse" }}>
          ...
          <tbody>
            ...
            {stats.length === 0 && <tr><td colSpan={7} style={{ ...td, textAlign: "center", color: "#747474", padding: 20 }}>No tiered closers. <Link href="/floor-manager/closers" style={{ color: "#0176d3" }}>Set up your closers and tiers</Link>.</td></tr>}
          </tbody>
        </table>
      </div>
    </div>
